  ...
  if (userType !== "client") {
    return (
      <div className="mt-7 sm:mt-13 ml-6 lg:ml-12">
        ...
        <p className="text-gray-300">somente clientes.</p>
      ...
      <div className="mt-7 sm:mt-13 overflow-hidden">
        ...
        <div>
          <ul className="max-w-full border border-gray-500 rounded-[10px] pt-3 pb-0 ml-6 lg:ml-12 mr-6 lg:mr-12">
            ...
            {/* Cabeçalho */}
            <li className="w-full grid grid-cols-4 sm:grid-cols-7 gap-4 border-b border-gray-500 py-2 px-3 items-center"
            >
            ...
            {calleds.length > 0 ? (
              calleds.map((c, index) => {
                ...
                return (
                  <li
                    key={c.id}
                    className="max-w-full grid grid-cols-4  sm:grid-cols-7 gap-4 border-b border-gray-500 py-2 px-3 items-center"
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-1 min-w-0">
                      ...
                      <span className="text-gray-200 text-sm truncate">
                        {c.services.map((s: { title: string }) => s.title).join(", ")}
                      </span>
                    </div>
